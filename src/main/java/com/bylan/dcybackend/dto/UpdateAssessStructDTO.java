 ...
 * @author Rememorio
 */
@ApiModel("更新课程考核结构DTO")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class UpdateAssessStructDTO implements Serializable {
    ...
    public Boolean isValid() {
        return (assessStructWeight != null && assessStructWeight > 0.0) || assessStructDesc != null;
    }
